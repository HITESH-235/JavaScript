...
// Note : while using if-else if-else together, remember not to use semilcolon in between its lines.
...
// And so to escape from this con, we have used "break" statement, which works same as python.
